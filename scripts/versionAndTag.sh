#!/bin/bash
# todo este jednu a udelejme z toho custom github action
set -e
...
git remote add ci_origin https://miob-miob:"$2"@github.com/miob-miob/treeGardenVisualization.git
...
npm version "$1" -m "Publish tree-garden-tree-garden-visualization %s"
